...
function main() {
    ...
    const licenseKey = "";
    ...
    // 3. Load SDK
    BlinkInputSDK.loadWasmModule(loadSettings).then((sdk: BlinkInputSDK.WasmSDK) => {
...
async function startScan(sdk: BlinkInputSDK.WasmSDK) {
    ...
    // In this example, we create a VinRecognizer, which knows how to scan vin and extracts information from them.
    ...
    const videoRecognizer = await BlinkInputSDK.VideoRecognizer.createVideoRecognizerFromCameraStream(cameraFeed, recognizerRunner);
