...
export namespace Components {
    interface BlinkinputInBrowser {
        ...
        "licenseKey": string;
        /**
          * List of recognizers which should be used.  Available recognizers for BlinkInput:  - BarcodeRecognizer - SimNumberRecognizer - VinNumberRecognizer  Recognizers can be defined by setting HTML attribute "recognizers", for example:  `<blinkinput-in-browser recognizers="BarcodeRecognizer"></blinkinput-in-browser>`
         */
        ...
        /**
          * Specify recognizer options. This option can only bet set as a JavaScript property.  Pass an object to `recognizerOptions` property where each key represents a recognizer, while the value represents desired recognizer options.  ``` blinkInput.recognizerOptions = {    'BarcodeRecognizer': {      'slowerThoroughScan': true,    } } ```  For a full list of available recognizer options see source code of a recognizer. For example, list of available recognizer options for BarcodeRecognizer can be seen in the `src/Recognizers/BlinkBarcode/BarcodeRecognizer.ts` file.
         */
        "recognizerOptions": { [key: string]: any };
        /**
          * List of recognizers which should be used.  Available recognizers for BlinkInput:  - BarcodeRecognizer - SimNumberRecognizer - VinNumberRecognizer  Recognizers can be defined by setting JS property "recognizers", for example:  ``` const blinkInput = document.querySelector('blinkinput-in-browser'); blinkInput.recognizers = ['BarcodeRecognizer']; ```
         */
...
declare global {
    interface HTMLBlinkinputInBrowserElement extends Components.BlinkinputInBrowser, HTMLStencilElement {
    }
    var HTMLBlinkinputInBrowserElement: {
        prototype: HTMLBlinkinputInBrowserElement;
        new (): HTMLBlinkinputInBrowserElement;
    };
    ...
    interface HTMLElementTagNameMap {
        "blinkinput-in-browser": HTMLBlinkinputInBrowserElement;
...
declare namespace LocalJSX {
    ...
    interface IntrinsicElements {
        "blinkinput-in-browser": BlinkinputInBrowser;
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "blinkinput-in-browser": LocalJSX.BlinkinputInBrowser & JSXBase.HTMLAttributes<HTMLBlinkinputInBrowserElement>;
